    ...
    <Menu.Root>
      ...
      <Menu.Portal>
        <Menu.Positioner className="outline-none" sideOffset={8}>
          <Menu.Popup
            className="origin-[var(--transform-origin)] rounded-md 
            bg-gradient-to-r from-purple-700 via-black to-black 
            py-1 text-white shadow-lg shadow-gray-800 outline outline-1 outline-gray-800 
